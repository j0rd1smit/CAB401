...
public class SmithWatermanGotoh {
     ...
     *
     * @param sequence1     sequene #1 ({@link Sequence})
     * @param sequence2     sequene #2 ({@link Sequence})
     * @param matrix scoring matrix ({@link Matrix})
     * @param openGapPenalty      open gap penalty
     * @param extendGapPenalty      extend gap penalty
    ...
    public static Alignment align(Sequence sequence1, Sequence sequence2, Matrix matrix,
       ...
       // Initializes the boundaries of the traceback matrix to STOP.
        ...
        Cell cell = sw.construct(sequence1, sequence2, scores, openGapPenalty, extendGapPenalty, pointers, sizesOfVerticalGaps, sizesOfHorizontalGaps);
        Alignment alignment = sw.traceback(sequence1, sequence2, matrix, pointers, cell, sizesOfVerticalGaps, sizesOfHorizontalGaps);
        alignment.setName1(sequence1.getId());
        alignment.setName2(sequence2.getId());
        alignment.setMatrix(matrix);
        alignment.setOpen(openGapPenalty);
        alignment.setExtend(extendGapPenalty);
